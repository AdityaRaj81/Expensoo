      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-10 gap-x-8">
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-heading font-bold">Expensoo</span>
            </div>
            <p className="text-secondary-400 mb-6 max-w-xs sm:max-w-sm">
              Smart expense tracking made simple. Take control of your finances with powerful insights and easy-to-use tools.
            </p>
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/register" className="text-secondary-400 hover:text-white transition-colors">Get Started</Link></li>
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-secondary-400 hover:text-white transition-colors">Security</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-secondary-800 mt-8 pt-8 text-center">
          <p className="text-secondary-400 text-sm sm:text-base">
            &copy; 2025 Expensoo. All rights reserved. Made with <span role="img" aria-label="love">❤️</span> for better financial management.
          </p>
        </div>
      </div>
    </footer>
