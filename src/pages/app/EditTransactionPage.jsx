...
function EditTransactionPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-heading font-bold text-secondary-900">Edit Transaction</h1>
        <p className="text-secondary-600 mt-1">Update your transaction details</p>
      </div>
